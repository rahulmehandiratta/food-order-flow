...
$(document).ready(function () {
    ...
    var right_side_views = '<div class="right-side-views d-none">' +
        ...
        '<img src="html/template/assets/img/icons/siderbar-icon2.svg" class="feather-five" alt="">' +
        ...
        '<img src="html/template/assets/img/logo.png" alt="Logo" class="img-flex">' +
        '</a>' +
        '</div>' +
        '</div>' +
        '<div class="col-xl-6 col-sm-6 col-12">' +
        '<a class="btn-closed" href="javascript:void(0);"><img class="img-fliud" src="html/template/assets/img/icons/sidebar-delete-icon.svg" alt="demo"></a>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>' +
    ...
    var customize_link = '<div class="customizer-links">' +
        ...
        '<img src="html/template/assets/img/icons/sidebar-icon-01.svg" class="feather-five" alt="">' +
        '</a>' +
        '</li>' +
        '<li class="sidebar-icons">' +
        '<a href="#" class="navigation-add" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Tooltip on left">' +
        '<img src="html/template/assets/img/icons/sidebar-icon-02.svg" class="feather-five" alt="">' +
        '</a>' +
        '</li>' +
        '<li class="sidebar-icons">' +
        ...
        '<img src="html/template/assets/img/icons/sidebar-icon-03.svg" class="feather-five" alt="">' +
        '</a>' +
        '</li>' +
        '</ul>' +
        '</div>' +
        ...
        '<a class="sidebar-close" href="#"><img src="html/template/assets/img/icons/close-icon.svg" alt=""></a>' +
        '</div>' +
        '<div class="sidebar-body">' +
        '<h6 class="theme-title">Choose Mode</h6>' +
        '<div class="switch-wrapper">' +
        '<div id="dark-mode-toggle">' +
        '<span class="light-mode active"> <img src="html/template/assets/img/icons/sun-icon.svg" class="me-2" alt=""> Light</span>' +
        ...
        '<img class="img-fliud" src="html/template/assets/img/layout-ltr.png" alt="layout">' +
        '</div>' +
        '</div>' +
        '</div>' +
        '<div class="col-xl-6 ere">' +
        ...
        '</div>' +
        '<div class="layout-img">' +
        '<img class="img-fliud" src="html/template/assets/img/layout-rtl.png" alt="layout">' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>' +
        ...
        '</div>' +
        '<div class="layout-img">' +
        '<img class="img-fliud" src="html/template/assets/img/layout-04.png" alt="layout">' +
        '</div>' +
        '</div>' +
        '</div>' +
        '<div class="col-xl-6 ere">' +
        ...
        '</div>' +
        '<div class="layout-img">' +
        '<img class="img-fliud" src="html/template/assets/img/layout-01.png" alt="layout">' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>' +
        ...
        '</div>' +
        '<div class="layout-img">' +
        '<img class="img-fliud" src="html/template/assets/img/layout-03.png" alt="layout">' +
        '</div>' +
        '</div>' +
        '</div>' +
        '<div class="col-xl-6 ere">' +
